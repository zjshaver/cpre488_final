------------------------------------------------------------------------------
-- axis_color_filter - entity/architecture pair
------------------------------------------------------------------------------
--
-- ***************************************************************************
...
--
------------------------------------------------------------------------------
-- Filename:          axis_color_filter
-- Version:           1.00.a
-- Description:       Example Axi Streaming core (VHDL).
-- Date:              Sun Dec  6 19:45:53 2015 (by Create and Import Peripheral Wizard)
...
end axis_color_filter;

------------------------------------------------------------------------------
-- Architecture Section
------------------------------------------------------------------------------

-- In this section, we povide an example implementation of ENTITY axis_color_filter
...
-- ENTITY axis_color_filter to implement your coprocessor

architecture EXAMPLE of axis_color_filter is
...
begin
   ...
   -- driver's axis_color_filter.c file
