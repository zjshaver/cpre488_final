...
xst -ifn xst.scr
move mmcm_iserdes_divider_v6_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\mmcm_iserdes_divider_v6.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mmcm_iserdes_divider_v6.ucf mmcm_iserdes_divider_v6_exdes

echo 'Running map'
map -timing -pr b mmcm_iserdes_divider_v6_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm mmcm_iserdes_divider_v6_exdes -w routed.ncd routed.vhd
cd ..
