...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\FMC_IMAGEON_Tests\ml605_avnet_hw04
  logical library name                       : fmc_imageon_vita_receiver_v1_00_a
  top name                                   : fmc_imageon_vita_receiver
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/fmc_imageon_vita_receiver.vhd
...
- XPS interface file(s)
  ...
  data/fmc_imageon_vita_receiver_v2_1_0.mpd
  ...
  data/fmc_imageon_vita_receiver_v2_1_0.pao
...
- Driver source file(s)
  ...
  src/fmc_imageon_vita_receiver.h
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/fmc_imageon_vita_receiver_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/fmc_imageon_vita_receiver_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\FMC_IMAGEON_Tests\ml605_avnet_hw04\C:\Xilinx\13.2\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
