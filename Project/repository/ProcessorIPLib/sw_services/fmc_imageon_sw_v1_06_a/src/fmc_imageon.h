...
struct struct_fmc_imageon_video_timing_t
{
   //char *pName;
...
typedef struct struct_fmc_imageon_video_timing_t fmc_imageon_video_timing_t;
...
// DDC/EDID Functions
int fmc_imageon_hdmii_read_edid( fmc_imageon_t *pContext, Xuint8 data[256] );
int fmc_imageon_hdmii_write_edid( fmc_imageon_t *pContext, Xuint8 data[256] );
int fmc_imageon_hdmio_read_edid( fmc_imageon_t *pContext, Xuint8 data[256] );
